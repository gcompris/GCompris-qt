...
// /* GCompris -  OrderingNumberEditor.qml
//  *
...
//     //     ListElement { name: "itemCount";     label: qsTr("Number of items");   type: "comboInt";  def: "[3,8]" }
//     //     ListElement { name: "minValue";      label: qsTr("Minimum value");     type: "int";       def: "1" }
//     //     ListElement { name: "maxValue";      label: qsTr("Maximum value");     type: "int";       def: "100" }
//     //     ListElement { name: "sortDirection"; label: qsTr("Sorting order");    type: "combo";     def: "['ascending', 'descending', 'random']" }
//     //     ListElement { name: "allowDecimals"; label: qsTr("Allow decimals");    type: "boolean";   def: "false" }
//     //     ListElement { name: "allowNegatives";label: qsTr("Allow negatives");   type: "boolean";   def: "false" }
//     // }
...
//     //             FieldEdit { name: "itemCount" }
//     //             FieldEdit { name: "minValue" }
//     //             FieldEdit { name: "maxValue" }
//     //             FieldEdit { name: "sortDirection" }
//     //             FieldEdit { name: "allowDecimals" }
//     //             FieldEdit { name: "allowNegatives" }
//     //         }
//     //     }
//     // }
