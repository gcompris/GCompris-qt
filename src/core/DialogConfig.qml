...
Rectangle {
    ...
    ListModel {
        ...
        Component.onCompleted: {
            ...
            languages.append( { "text": "Scottish Gaelic", "locale": "gd_GB.UTF-8" } )
            languages.append( { "text": "Galego", "locale": "gl_ES.UTF-8" } )
            languages.append( { "text": "Magyar", "locale": "hu_HU.UTF-8" } )
            languages.append( { "text": "Lietuvos", "locale": "lt_LT.UTF-8" } )
            languages.append( { "text": "Latvijas", "locale": "lv_LV.UTF-8" } )
            languages.append( { "text": "Nederlands", "locale": "nl_NL.UTF-8" } )
            languages.append( { "text": "Nynorsk", "locale": "nn_NO.UTF-8" } )
            ...
            languages.append( { "text": "Slovenčina", "locale": "sk_SK.UTF-8" } )
            languages.append( { "text": "Slovenščina", "locale": "sl_SI.UTF-8" } )
            languages.append( { "text": "црногорски jeзик", "locale": "sr_ME.UTF-8" } )
            languages.append( { "text": "Svensk", "locale": "sv_FI.UTF-8" } )
            ...
            languages.append( { "text": "中國", "locale": "zh_TW.UTF-8" } )
        }
    }
