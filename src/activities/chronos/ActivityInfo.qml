...
//  intro: "Slide the pictures into the order that tells the story"
  //: Help goal
  goal: qsTr("Develop the ability to recognize the chronology of a story.")
  //: Help prerequisite
  prerequisite: qsTr("Tell a short story.")
  //: Help manual
  manual: qsTr("Arrange the pictures to make a coherent story. Drag the pictures from the side bar to the corresponding dots, then click the OK button to validate your answer.")
