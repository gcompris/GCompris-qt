 ...
 *   Pulkit Gupta <pulkitgenius@gmail.com> (Qt Code Base)
 *   Shivansh Bajaj <shivanshbajaj1@gmail.com> (Qt Quick Version)
 *
...
ActivityBase {
    ...
    property string url: "qrc:/gcompris/src/activities/solarsystem/resource/"
    property int levelCount: 2
    ...
    pageComponent: Rectangle {
        ...
        Rectangle {
            ...
            Image {
                id: bg
                anchors.fill: parent
                source: "resource/images/stars.jpg"
            }
            color: "transparent"
            z: 2
