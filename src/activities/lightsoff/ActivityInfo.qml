...
ActivityInfo {
  ...
  demo: false
  title: qsTr("Light Off")
  description: qsTr("The aim is to switch off all the lights.")
  goal: qsTr("The aim is to switch off all the lights.")
  prerequisite: ""
  manual: qsTr("The effect of pressing a button is to toggle the state of that button, and of its immediate vertical and horizontal neighbors. The color of the sky depend on the number of clicks needed to solve the puzzle. If you click on Tux, the solution is shown.")
