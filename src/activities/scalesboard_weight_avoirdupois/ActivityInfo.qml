...
ActivityInfo {
  ...
  prerequisite: ""
  manual: qsTr("To balance the scales, move the masses on the left or the right side. Take care of the weight and the unit of the masses, remember that a pound (lb) is sixteen ounce (oz). They can be arranged in any order.")
  credit: ""
  section: "/math/algebramenu units"
}
