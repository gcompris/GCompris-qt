...
Dataset {
    objective: qsTr("Guess a number between 1 and 1 000 000.")
    difficulty: 5
    data: [
        {
        ...
        {
            "objective" : qsTr("Guess a number between 1 and %1").arg(1000),
            "maxNumber" : 1000
        },
        {
            "objective" : qsTr("Guess a number between 1 and %1").arg(100000),
            "maxNumber" : 100000
        },
        {
            "objective" : qsTr("Guess a number between 1 and %1").arg(1000000),
            "maxNumber" : 1000000
        }
    ]
}
