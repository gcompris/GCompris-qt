	...
	return [
		{
			...
			"levels": [
				{ //sub-level 1
					"question": qsTr("It takes _____ for the Sun’s light to reach the earth"),
					"options": [qsTr("8 minutes"),qsTr("30 minutes"),qsTr("60 minutes"),qsTr("15 minutes")],
					"closeness": [qsTr("100%"),qsTr("58.1%%"),qsTr("1%"),qsTr("86.6%")]
				},
				{ //sub-level 2
					"question": qsTr("The temperature of the sun is around _____degrees"),
					"options": [qsTr("1000"),qsTr("4500"),qsTr("5505"),qsTr("3638")],
					"closeness": [qsTr("1%"),qsTr("78%"),qsTr("100%"),qsTr("60%")]
				},
				{ //sub-level 3
					"question": qsTr("Sun is ___ years old"),
					"options": [qsTr("1.2 billion"),qsTr("3 billion"),qsTr("7 billion"),qsTr("4.5 billion")],
					"closeness": [qsTr("1%"),qsTr("55%"),qsTr("25%"),qsTr("100%")]
				},
				{ //sub-level 4
		...
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"closeness": [qsTr("1%"),qsTr("17.5%"),qsTr("100%"),qsTr("50.5%")]
				},
				{ //sub-level 2
					"question": qsTr("On Mercury, we can survive only for"),
					"options": [qsTr("2 minutes"),qsTr("4 minutes"),qsTr("1 minute"),qsTr("60 minutes")],
					"closeness": [qsTr("100%"),qsTr("96.6%"),qsTr("98.2%"),qsTr("1%")]
				},
				{ //sub-level 3
					"question": qsTr("How many moons does Mercury has?"),
					"options": [qsTr("5"),qsTr("200"),qsTr("0"),qsTr("10")],
					"closeness": [qsTr("97.5%"),qsTr("1%"),qsTr("100%"),qsTr("95%")]
				},
				{ //sub-level 4
		...
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"closeness": [qsTr("1%"),qsTr("100%"),qsTr("35%"),qsTr("35%")]
				},
				{ //sub-level 2
					...
					"closeness": [qsTr("54.3%"),qsTr("7.3%"),qsTr("1%"),qsTr("100%")]
				},
				{ //sub-level 3
					"question": qsTr("How many moons does Earth has?"),
					"options": [qsTr("One"),qsTr("Five"),qsTr("Two"),qsTr("Three")],
					"closeness": [qsTr("100%"),qsTr("15"),qsTr("75.2%"),qsTr("50.5%")]
				},
				{ //sub-level 4
					"question": qsTr("How long is a day on Earth?"),
					"options": [qsTr("12 Hours"),qsTr("24 Hours"),qsTr("365 Hours"),qsTr("48 Hours")],
					"closeness": [qsTr("96.5%"),qsTr("100%"),qsTr("1%"),qsTr("93%")]
				},
				{ //sub-level 5
					"question": qsTr("Earth has ____ seasons."),
					"options": [qsTr("2"),qsTr("4"),qsTr("6"),qsTr("1")],
					"closeness": [qsTr("34%"),qsTr("100%"),qsTr("34%"),qsTr("1%")]
				}
			]
		},
		{
		...
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"closeness": [qsTr("75.2%"),qsTr("75.2%"),qsTr("1%"),qsTr("100%")]
				},
				{ //sub-level 2
					...
					"closeness": [qsTr("50.5%"),qsTr("100%"),qsTr("1%"),qsTr("75.2%")]
				},
				{ //sub-level 3
					"question": qsTr("Jupiter is as big as"),
					"options": [qsTr("20"),qsTr("100"),qsTr("1000"),qsTr("3000")],
					"closeness": [qsTr("1%"),qsTr("7.2%"),qsTr("85.5%"),qsTr("100%")]
				},
				{ //sub-level 4
					"question": qsTr("How many moons does Jupiter has?"),
					"options": [qsTr("1"),qsTr("20"),qsTr("25"),qsTr("16")],
					"closeness": [qsTr("70.1%"),qsTr("92.5%"),qsTr("1%"),qsTr("100%")]
				},
				{ //sub-level 5
					"question": qsTr("How long is one day on Jupiter?"),
					"options": [qsTr("10 Hours"),qsTr("24 Hours"),qsTr("12 Hours"),qsTr("48 Hours")],
					"closeness": [qsTr("100%"),qsTr("63.5%"),qsTr("94.8%"),qsTr("1%")]
				}
			]
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"options": [qsTr("Sixth"),qsTr("Fourth"),qsTr("First"),qsTr("Fifth")],
					"closeness": [qsTr("100%"),qsTr("60.4%"),qsTr("1%"),qsTr("80.2%")]
				},
				{ //sub-level 2
					"question": qsTr("Saturn is the ______ largest  planet in the Solar System"),
					"options": [qsTr("Third"),qsTr("First"),qsTr("Fifth"),qsTr("Second")],
					"closeness": [qsTr("67%"),qsTr("67%"),qsTr("1%"),qsTr("100%")]
				},
				{ //sub-level 3
					"question": qsTr("How many moons does Saturn has?"),
					"options": [qsTr("120"),qsTr("1"),qsTr("150"),qsTr("200")],
					"closeness": [qsTr("80%"),qsTr("1%"),qsTr("100%"),qsTr("60.8%")]
				},
				{ //sub-level 4
					"question": qsTr("How long is one day on Saturn?"),
					"options": [qsTr("10.5 Hours"),qsTr("24 Hours"),qsTr("12 Hours"),qsTr("48 Hours")],
					"closeness": [qsTr("100%"),qsTr("64.3%"),qsTr("96%"),qsTr("1%")]
				},
				{ //sub-level 5
					"question": qsTr("Saturn is as big as ____ Earths"),
					"options": [qsTr("100"),qsTr("764"),qsTr("300"),qsTr("1300")],
					"closeness": [qsTr("1%"),qsTr("100%"),qsTr("30.8%"),qsTr("20.1%")]
				}
			]
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"closeness": [qsTr("100%"),qsTr("1%"),qsTr("67%"),qsTr("34%")]
				},
				{ //sub-level 2
					"question": qsTr("How many years does it take Uranus to go once around the Sun?"),
					"options": [qsTr("1"),qsTr("24"),qsTr("68"),qsTr("84")],
					"closeness": [qsTr("1%"),qsTr("28.4%"),qsTr("80.9%"),qsTr("100%")]
				},
				{ //sub-level 3
					"question": qsTr("How many moons does Uranus has?"),
					"options": [qsTr("120"),qsTr("87"),qsTr("27"),qsTr("50")],
					"closeness": [qsTr("1"),qsTr("36.1"),qsTr("100"),qsTr("75.5%")]
				},
				{ //sub-level 4
					"question": qsTr("How long is one day on Uranus?"),
					"options": [qsTr("10 Hours"),qsTr("27 Hours"),qsTr("17 Hours"),qsTr("48 Hours")],
					"closeness": [qsTr("77.6%"),qsTr("68%"),qsTr("100%"),qsTr("1%")]
				},
				{ //sub-level 5
					...
					"closeness": [qsTr("100%"),qsTr("50.5%"),qsTr("1%"),qsTr("75.2%")]
				}
			]
		},
		{
			...
			"levels": [
				{ //sub-level 1
					...
					"options": [qsTr("Seventh"),qsTr("Fourth"),qsTr("Eighth"),qsTr("Fifth")],
					"closeness": [qsTr("75.2%"),qsTr("1%"),qsTr("100%"),qsTr("25.7%")]
				},
				{ //sub-level 2
