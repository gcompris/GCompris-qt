...
ActivityBase {
    ...
    id: background
        ...
        QtObject {
            ...
            property alias firstInitialVisible: firstInitial.visible
            ...
            property alias secondInitialVisible: secondInitial.visible
        ...
        Image {
            ...
            sourceSize.width: Math.min(background.height - 1.4 * player1.height - 1.2 * bar.height, 0.7 * background.width)
        ...
        Rectangle {
			...
			width: Math.min(Math.min(0.9 * parent.width - board.x - board.width, 0.68 * board.width), 150)
			height: 0.18 * board.height
			...
			GCText {
				...
				fontSize: Math.min(parent.height * 0.8,parent.width * 0.4) / 2
				color: "white"
				style: Text.Outline
				styleColor: "black"
		...
		Rectangle {
			...
			height: instruction.fontSize * 2.28 * Math.ceil(instruction.implicitWidth / instruction.width)
			opacity: 0.8
			radius: 10
			border.width: 2
			border.color: "black"
		...
		Rectangle {
			...
			width: instruction.width + 20
			height: instruction.fontSize * 2.5 * Math.ceil(instruction.implicitWidth / instruction.width)
			opacity: 0.8
			radius: 10
			border.width: 2
			border.color: "black"
        ...
        Rectangle {
            id: player2
            height: Math.min(background.height/10,Math.min(background.width/7,bar.height * 1.05))
            width: height * 11/8
            anchors {
                top: background.top
                topMargin: 5
