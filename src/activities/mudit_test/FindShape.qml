...
import "../../core"
import "findshape.js" as Activity
...
ActivityBase {
    ...
    pageComponent: Image {
        ...
        GridView {
            ...
            x: background.width * 0.25
            y: background.height * 0.24
            width: background.width * 0.7
            height: background.height * 0.7
            interactive: false
            cellWidth: itemHeight + 8
            cellHeight: itemWidth + 8
            keyNavigationWraps: true

            property int itemWidth: Math.min((parent.width * 0.7) / (count / 2),
