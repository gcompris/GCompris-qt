...
//  intro: "Slide the images on their respective targets"
  //: Help goal
  goal: qsTr("Develop observation and spatial visualization.")
  prerequisite: ""
  //: Help manual
  manual: qsTr("Find the picture details displayed on the side bar and drag them from the bar to the right spot on the picture.")
