...
//  intro: "Help Tux find his way out. Use the Up arrow to go forwards, the other arrows to turn."
  ...
  prerequisite: ""
  manual: qsTr("Use the arrows keys to move Tux up to the door. In this maze, the move is relative (first person). Use the up arrow to go forward. The other arrows let you turn Tux in another direction.
