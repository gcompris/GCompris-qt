...
ActivityInfo {
  ...
  //: Help manual
  manual: qsTr("You are either asked to send a message in Morse code or convert the received Morse code message to letters or digits. To learn the Morse code, you can have a look at the translation map which contains the code for all the letters and digits by clicking on the Morse key icon.")
  credit: ""
