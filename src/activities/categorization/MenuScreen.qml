...
Image {
    ...
    Keys.enabled : (items.mode == "expert" || items.mode == "noInstructionsScoreVisible") ? false : true
    Keys.onPressed: {
    ...
    GridView {
        ...
        delegate: Item {
            ...
            opacity: (items.mode == "expert" || items.mode == "noInstructionsScoreVisible") ? 0.25 : 1
            ...
            Image {
                ...
                GCText {
                    ...
                    text: name
                    opacity: (items.mode == "expert" || items.mode == "noInstructionsScoreVisible") ? 0 : 1
                }
            }
            ...
            MouseArea {
                anchors.fill: activityBackground
                enabled: menuScreen.started && (items.mode != "expert" && items.mode != "noInstructionsScoreVisible")
        ...
        highlight: Rectangle {
            ...
            border.width: 3
            border.color: "black"
            visible: (items.mode == "expert" || items.mode == "noInstructionsScoreVisible") ? false : true
