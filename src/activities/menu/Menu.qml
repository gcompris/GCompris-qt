            ...
            Connections {
                ...
                function onStatusChanged() {
                    ...
                    case NetConst.DISCONNECTED:
                        ...
                        break;
                    default:
                        ApplicationInfo.setServerStatusColor("#80ffffff"); // transparent white
