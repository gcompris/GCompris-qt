...
Item{
    ...
    property string intro2: qsTr("Since the gravitational force is directly proportional to the mass of both"
                                 +"\n"+" interacting objects, more massive objects will attract each other with"
                                 +"\n"+" a greater gravitational force.So as the mass of either object increases,"
                                 +"\n"+" the force of gravitational attraction between them also increases but"
                                 +"\n"+" this force is inversely proportional to the square of the separation"
