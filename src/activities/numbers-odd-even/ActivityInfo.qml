...
//  intro: "Move the helicopter to catch the clouds having even or odd numbers, in the shown order."
    ...
    prerequisite: ""
    //: Help manual
    manual: qsTr("Catch the clouds with an odd or even number as specified in the instructions, in the right order. With a keyboard, use the arrow keys to move the helicopter. With a pointing device, just click or tap on the target location. At first levels you can see which number you have to catch on the counter in the bottom right corner, then on next levels you need to remember it.") + ("<br><br>") +
