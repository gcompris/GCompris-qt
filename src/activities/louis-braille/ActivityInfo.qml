...
ActivityInfo {
  ...
  //: Help title
  description: qsTr("Read some key events in the life of the braille system inventor, and remember their chronological order.")
  //intro: "Discover the history of Louis Braille."
  //: Help goal
  goal: qsTr("Remember the order of an event sequence. Get to know the biography of Louis Braille.")
  prerequisite: ""
  //: Help manual
