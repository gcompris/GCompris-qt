...
ActivityInfo {
  name: "memory-math-add-minus-mult-div-tux/Memory-math-add-minus-mult-div-tux.qml"
  difficulty: 1
  ...
  goal: qsTr("Practise addition, subtraction, multiplication, division, until all the cards are gone.")
