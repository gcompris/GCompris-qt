...
ActivityBase {
    ...
    property var fen: [
        ["Pawn", "4k3/p7/1p2p3/2pp1p1p/6p1/8/PPPPPPPP/4K3 w - - 0 1"],
        ["Rook", "4k3/p5p1/2pp4/1p4p1/3p1p2/8/8/R3K3 w Q - 0 1"],
        ["Knight", "p3k3/2p1p3/ppp3r1/8/rp5p/5p2/8/4K1N1 w - - 0 1"],
        ["Bishop", "4k3/1r5r/p1p5/1n2p1np/pp1p2p1/8/8/2B1KB2 w - - 0 1"],
        ["Queen", "4k3/1n5r/6p1/1r1p2nb/pp1b1p2/2p1p2p/8/3QK3 w - - 0 1"],
        ["King", "4k3/8/4r3/3b4/3r4/4b3/4p3/4K3 w - - 0 1"],
        ["initial state", "6q1/8/7r/5b2/8/4N3/8/K7 w - - 0 1"]
