...
ActivityInfo {
  ...
  //intro: "Drag the arrow to select a part of the bar then drop it in the empty area to represent the decimal number."
  //: Help goal
  goal: qsTr("Learn decimals by counting how many bars are needed to represent the decimal number.")
  //: Help prerequisite
  prerequisite: ""
  //: Help manual
