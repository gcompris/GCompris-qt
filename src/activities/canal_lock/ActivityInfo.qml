...
ActivityInfo {
  ...
  intro: "You are responsible for the lock and you must help Tux pass through. Click on the small valves to cause either a drop or a//n increase in the water level."
  goal: ""
  prerequisite: ""
