...
ActivityInfo {
  ...
  //intro: "You are responsible for the lock and you must help Tux pass through. Click on the red valves to cause either a drop or an increase in the water level, and click on the green gates to open or close a path."
  goal: ""
  prerequisite: ""
