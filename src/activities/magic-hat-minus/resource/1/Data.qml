 ...
 *          // maximum number of stars for each row of first operand. First number should be at least 2 for subtractions, others between 0 and 10.
 *          "maxStars": [3, 0, 0],
 *          // minimum number of stars for each row of first operand. First number should be at least 2 for subtractions, others between 0 and 10.
