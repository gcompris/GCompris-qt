...
To test your translated files:

* Copy the example files: [grammar_analysis-xx.json](examples/grammar_analysis-xx.md) and [grammar_classes-xx.json](examples/grammar_classes-xx.md) in the directory `$HOME/.local/share/GCompris/`.
