...
include(src/activities/clockgame/clockgame.pri)
...
include(src/activities/lightsoff/lightsoff.pri)
...
include(src/activities/money_back_cents/money_back_cents.pri)
include(src/activities/money_back/money_back.pri)
include(src/activities/money_cents/money_cents.pri)
